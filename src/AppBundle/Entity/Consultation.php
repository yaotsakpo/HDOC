...
class Consultation
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="Controle", type="datetime",nullable=true)
     */
    private $controle;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Patient",inversedBy="consultations",cascade={"persist"})
